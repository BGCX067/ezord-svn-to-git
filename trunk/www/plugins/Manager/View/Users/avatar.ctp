<?php echo $this->Form->create('User', array ('action' => 'avatar', 'type' => 'file', 'method' => 'post')) ?>
    ...
    <div class="avatar">
        <?php if (!empty($user['UserProfile']['avatar'])) : ?>
            ...
            <span>
                ...
                <?php echo $this->Html->link('Delete this avatar', '/manager/users/delete_avatar/'.$uid, array(), 'Are you sure?') ?>
            </span>
        <?php else: ?>
