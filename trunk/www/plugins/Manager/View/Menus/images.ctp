<?php echo $this->Form->create('MenuItem', array ('action' => 'images/'.$pid.'/'.$iid, 'type' => 'file', 'method' => 'post')) ?>
    ...
    <fieldset>
		...
		<p class="input_field">
            ...
            <?php echo $this->Html->link('Complete', '/manager/menu_items/index/'.$pid, array ('class' => 'button')) ?>
