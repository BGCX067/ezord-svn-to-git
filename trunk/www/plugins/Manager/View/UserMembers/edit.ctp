...
<?php echo $this->Form->create('UserMember', array ('id' => 'UserMemberForm', 'action' => $action, 'method' => 'post')) ?>
    ...
    <fieldset id="register-form">
		...
		<p class="input_field">
            ...
            <?php echo $this->Html->link('Cancel', '/manager/user_members/', array('class' => 'button')) ?>
		</p>
	</fieldset>
